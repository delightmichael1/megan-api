...
export const handleAddlesson = async (req, res) => {
    try {
...
export const handleGetLessons = async (req, res) => {
    try {
        ...
        for (var lessondata of lessons) {
            ...
            lessondata.modules = modules.map(moduledata => ({
...
export const handleGetLesson = async (req, res) => {
    try {
...
export const handlePublishLesson = async (req, res) => {
    try {
        const { id } = req.params;
...
export const handleGetupcomingLessons = async (req, res) => {
    try {
...
function getUpcomingSessions(lessons) {
    const now = new Date();
    return lessons
        .filter(lesson => {
...
export const handleEnrolltoLesson = async (req, res) => {
    try {
