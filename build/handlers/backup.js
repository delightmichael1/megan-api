...
import { uploadBuffer } from "./documentsUpload.js";
...
export async function backupMongoDBRemote(mongoUri, dbName) {
    ...
    try {
        ...
        for (const col of collections) {
            ...
            fs.writeFileSync(`${dumpDir}/${col.collectionName}.json`, JSON.stringify(data, null, 2));
        }
        // Zip folder
...
export async function handleGetBackups(req, res) {
    try {
