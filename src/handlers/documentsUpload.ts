 ...
 */
export async function uploadBuffer(buffer: Buffer, originalName: string, destFolder: string = "uploads"): Promise<{ url: string, filePath: string }> {
...
export async function uploadMulterFile(
  ...
  destFolder: string = "uploads"
): Promise<{ url: string, filePath: string, link: string }> {
