...
export const handleAddmodule = async (req: any, res: any): Promise<Response | void> => {
    try {
...
export const handleGetmodules = async (req: any, res: any): Promise<Response | void> => {
    try {
...
export const handleGetmodule = async (req: any, res: any): Promise<Response | void> => {
    try {
...
export const handleDeletemodule = async (req: any, res: any): Promise<Response | void> => {
    try {
...
export const handleUpdatemodule = async (req: any, res: any): Promise<Response | void> => {
    try {
